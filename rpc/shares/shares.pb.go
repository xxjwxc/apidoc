...
var file_shares_shares_proto_rawDesc = []byte{
	...
	0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x32, 0xa4, 0x04,
	...
	0x47, 0x72, 0x6f, 0x75, 0x70, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x12, 0x31, 0x0a, 0x06, 0x53,
	...
	0x74, 0x79, 0x22, 0x00, 0x42, 0x0c, 0x5a, 0x0a, 0x72, 0x70, 0x63, 0x2f, 0x73, 0x68, 0x61, 0x72,
...
var file_shares_shares_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
...
var file_shares_shares_proto_depIdxs = []int32{
	...
	22, // 7: shares.shares.GetGroup:input_type -> common.Empty
	4,  // 8: shares.shares.Search:input_type -> shares.SearchReq
	6,  // 9: shares.shares.Gets:input_type -> shares.GetsReq
	22, // 10: shares.shares.GetAllCodeName:input_type -> common.Empty
	11, // 11: shares.shares.AddMyCode:input_type -> shares.AddMyCodeReq
	13, // 12: shares.shares.GetMyCode:input_type -> shares.GetMyCodeReq
	22, // 13: shares.shares.GetMsg:input_type -> common.Empty
	22, // 14: shares.shares.HaveNewMsg:input_type -> common.Empty
	19, // 15: shares.shares.DeleteMyCode:input_type -> shares.DeleteMyCodeReq
	20, // 16: shares.shares.AddGroup:input_type -> shares.AddGroupReq
	3,  // 17: shares.shares.GetGroup:output_type -> shares.GetGroupResp
	5,  // 18: shares.shares.Search:output_type -> shares.SearchResp
	8,  // 19: shares.shares.Gets:output_type -> shares.GetsResp
	10, // 20: shares.shares.GetAllCodeName:output_type -> shares.GetAllCodeNameResp
	12, // 21: shares.shares.AddMyCode:output_type -> shares.AddMyCodeResp
	15, // 22: shares.shares.GetMyCode:output_type -> shares.GetMyCodeResp
	17, // 23: shares.shares.GetMsg:output_type -> shares.GetMsgResp
	18, // 24: shares.shares.HaveNewMsg:output_type -> shares.HaveNewMsgResp
	22, // 25: shares.shares.DeleteMyCode:output_type -> common.Empty
	22, // 26: shares.shares.AddGroup:output_type -> common.Empty
