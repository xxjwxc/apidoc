...
var file_shares_shares_proto_rawDesc = []byte{
	...
	0x2e, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x32, 0xf9, 0x05, 0x0a,
	...
	0x61, 0x79, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x42, 0x0c, 0x5a, 0x0a, 0x72, 0x70, 0x63, 0x2f,
...
var file_shares_shares_proto_depIdxs = []int32{
	...
	3,  // 22: shares.shares.GetGroup:output_type -> shares.GetGroupResp
	22, // 23: shares.shares.GetMyGroup:output_type -> shares.GetMyGroupResp
	25, // 24: shares.shares.UpsetGroupCode:output_type -> common.Empty
	5,  // 25: shares.shares.Search:output_type -> shares.SearchResp
	8,  // 26: shares.shares.Gets:output_type -> shares.GetsResp
	10, // 27: shares.shares.GetAllCodeName:output_type -> shares.GetAllCodeNameResp
	12, // 28: shares.shares.AddMyCode:output_type -> shares.AddMyCodeResp
	15, // 29: shares.shares.GetMyCode:output_type -> shares.GetMyCodeResp
	17, // 30: shares.shares.GetMsg:output_type -> shares.GetMsgResp
	18, // 31: shares.shares.HaveNewMsg:output_type -> shares.HaveNewMsgResp
	25, // 32: shares.shares.DeleteMyCode:output_type -> common.Empty
	25, // 33: shares.shares.AddGroup:output_type -> common.Empty
	24, // 34: shares.shares.GetDay:output_type -> shares.GetDayResp
	24, // 35: shares.shares.GetVip:output_type -> shares.GetDayResp
