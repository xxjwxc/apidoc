...
var file_shares_shares_proto_rawDesc = []byte{
	...
	0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x22, 0x8e, 0x03, 0x0a, 0x0c, 0x41,
	...
	0x64, 0x65, 0x52, 0x65, 0x71, 0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x22, 0xdd, 0x01, 0x0a, 0x03,
	...
	0x18, 0x0a, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6e, 0x6f, 0x77, 0x22, 0x2d, 0x0a, 0x0a, 0x47,
	...
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x32, 0xa4, 0x04, 0x0a, 0x06, 0x73,
	...
	0x75, 0x70, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x12, 0x31, 0x0a, 0x06, 0x53, 0x65, 0x61, 0x72,
...
var file_shares_shares_proto_msgTypes = make([]protoimpl.MessageInfo, 20)
var file_shares_shares_proto_goTypes = []interface{}{
	...
	(*Msg)(nil),                // 15: shares.Msg
	(*GetMsgResp)(nil),         // 16: shares.GetMsgResp
	(*HaveNewMsgResp)(nil),     // 17: shares.HaveNewMsgResp
	(*DeleteMyCodeReq)(nil),    // 18: shares.DeleteMyCodeReq
	(*AddGroupReq)(nil),        // 19: shares.AddGroupReq
...
var file_shares_shares_proto_depIdxs = []int32{
	...
	15, // 6: shares.GetMsgResp.list:type_name -> shares.Msg
	20, // 7: shares.shares.GetGroup:input_type -> common.Empty
	3,  // 8: shares.shares.Search:input_type -> shares.SearchReq
	5,  // 9: shares.shares.Gets:input_type -> shares.GetsReq
	20, // 10: shares.shares.GetAllCodeName:input_type -> common.Empty
	10, // 11: shares.shares.AddMyCode:input_type -> shares.AddMyCodeReq
	12, // 12: shares.shares.GetMyCode:input_type -> shares.GetMyCodeReq
	20, // 13: shares.shares.GetMsg:input_type -> common.Empty
	20, // 14: shares.shares.HaveNewMsg:input_type -> common.Empty
	18, // 15: shares.shares.DeleteMyCode:input_type -> shares.DeleteMyCodeReq
	19, // 16: shares.shares.AddGroup:input_type -> shares.AddGroupReq
	2,  // 17: shares.shares.GetGroup:output_type -> shares.GetGroupResp
	4,  // 18: shares.shares.Search:output_type -> shares.SearchResp
	7,  // 19: shares.shares.Gets:output_type -> shares.GetsResp
	9,  // 20: shares.shares.GetAllCodeName:output_type -> shares.GetAllCodeNameResp
	11, // 21: shares.shares.AddMyCode:output_type -> shares.AddMyCodeResp
	14, // 22: shares.shares.GetMyCode:output_type -> shares.GetMyCodeResp
	16, // 23: shares.shares.GetMsg:output_type -> shares.GetMsgResp
	17, // 24: shares.shares.HaveNewMsg:output_type -> shares.HaveNewMsgResp
	20, // 25: shares.shares.DeleteMyCode:output_type -> common.Empty
	20, // 26: shares.shares.AddGroup:output_type -> common.Empty
