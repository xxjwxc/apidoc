...
var file_shares_shares_proto_rawDesc = []byte{
	...
	0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x32, 0xda, 0x01, 0x0a, 0x06, 0x73,
...
var file_shares_shares_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
...
var file_shares_shares_proto_depIdxs = []int32{
	...
	10, // 5: shares.shares.GetGroup:input_type -> common.Empty
	3,  // 6: shares.shares.Search:input_type -> shares.SearchReq
	5,  // 7: shares.shares.Gets:input_type -> shares.GetsReq
	10, // 8: shares.shares.GetAllCodeName:input_type -> common.Empty
	2,  // 9: shares.shares.GetGroup:output_type -> shares.GetGroupResp
	4,  // 10: shares.shares.Search:output_type -> shares.SearchResp
	7,  // 11: shares.shares.Gets:output_type -> shares.GetsResp
	9,  // 12: shares.shares.GetAllCodeName:output_type -> shares.GetAllCodeNameResp
