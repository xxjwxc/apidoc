...
type AddMyCodeReq struct {
	...
	Up          int32   `protobuf:"varint,6,opt,name=up,proto3" json:"up"`                    // 估价涨到
	Down        int32   `protobuf:"varint,7,opt,name=down,proto3" json:"down"`                // 估价跌到
...
func (x *AddMyCodeReq) GetUp() int32 {
	if x != nil {
		return x.Up
	}
	return 0
...
func (x *AddMyCodeReq) GetDown() int32 {
	if x != nil {
		return x.Down
	}
	return 0
...
var file_shares_shares_proto_rawDesc = []byte{
	...
	0x02, 0x75, 0x70, 0x18, 0x06, 0x20, 0x01, 0x28, 0x05, 0x52, 0x02, 0x75, 0x70, 0x12, 0x12, 0x0a,
	0x04, 0x64, 0x6f, 0x77, 0x6e, 0x18, 0x07, 0x20, 0x01, 0x28, 0x05, 0x52, 0x04, 0x64, 0x6f, 0x77,
