...
var file_shares_shares_proto_rawDesc = []byte{
	...
	0xb8, 0x10, 0x0a, 0x06, 0x73, 0x68, 0x61, 0x72, 0x65, 0x73, 0x12, 0x31, 0x0a, 0x08, 0x47, 0x65,
	...
	0x06, 0x47, 0x65, 0x74, 0x44, 0x61, 0x79, 0x12, 0x0f, 0x2e, 0x73, 0x68, 0x61, 0x72, 0x65, 0x73,
	0x2e, 0x43, 0x6f, 0x64, 0x65, 0x52, 0x65, 0x71, 0x1a, 0x12, 0x2e, 0x73, 0x68, 0x61, 0x72, 0x65,
	0x73, 0x2e, 0x47, 0x65, 0x74, 0x44, 0x61, 0x79, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x12, 0x2f,
	...
	0x73, 0x2e, 0x43, 0x6f, 0x64, 0x65, 0x52, 0x65, 0x71, 0x1a, 0x12, 0x2e, 0x73, 0x68, 0x61, 0x72,
	0x65, 0x73, 0x2e, 0x47, 0x65, 0x74, 0x44, 0x61, 0x79, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x12,
	0x31, 0x0a, 0x08, 0x47, 0x65, 0x74, 0x48, 0x65, 0x6a, 0x6a, 0x77, 0x12, 0x0d, 0x2e, 0x63, 0x6f,
	...
	0x6c, 0x69, 0x6e, 0x65, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x42, 0x0c, 0x5a, 0x0a, 0x72, 0x70,
...
var file_shares_shares_proto_depIdxs = []int32{
	...
	28, // 78: shares.shares.GetJgKline:input_type -> shares.GetSharesKlineReq
	28, // 79: shares.shares.GetGzKline:input_type -> shares.GetSharesKlineReq
	25, // 80: shares.shares.GetHotHyName:input_type -> shares.GetHotHyNameReq
	20, // 81: shares.shares.GetYyq:input_type -> shares.GetYyqReq
	13, // 82: shares.shares.GetMrtList:input_type -> shares.GetMrtListReq
	11, // 83: shares.shares.GetMrtCode:input_type -> shares.GetMrtCodeReq
	10, // 84: shares.shares.UpsetMrtCode:input_type -> shares.UpsetMrtCodeReq
	6,  // 85: shares.shares.GetMrtDetail:input_type -> shares.GetMrtDetailReq
	2,  // 86: shares.shares.GetZybHyKline:input_type -> shares.GetZybHyKlineReq
	44, // 87: shares.shares.GetGroup:output_type -> shares.GetGroupResp
	63, // 88: shares.shares.GetMyGroup:output_type -> shares.GetMyGroupResp
	78, // 89: shares.shares.UpsetGroupCode:output_type -> common.Empty
	46, // 90: shares.shares.Search:output_type -> shares.SearchResp
	49, // 91: shares.shares.Gets:output_type -> shares.GetsResp
	51, // 92: shares.shares.GetAllCodeName:output_type -> shares.GetAllCodeNameResp
	53, // 93: shares.shares.AddMyCode:output_type -> shares.AddMyCodeResp
	56, // 94: shares.shares.GetMyCode:output_type -> shares.GetMyCodeResp
	58, // 95: shares.shares.GetMsg:output_type -> shares.GetMsgResp
	59, // 96: shares.shares.HaveNewMsg:output_type -> shares.HaveNewMsgResp
	78, // 97: shares.shares.DeleteMyCode:output_type -> common.Empty
	78, // 98: shares.shares.AddGroup:output_type -> common.Empty
	65, // 99: shares.shares.GetDay:output_type -> shares.GetDayResp
	65, // 100: shares.shares.GetVip:output_type -> shares.GetDayResp
	65, // 101: shares.shares.GetFl:output_type -> shares.GetDayResp
	65, // 102: shares.shares.GetUp:output_type -> shares.GetDayResp
	16, // 103: shares.shares.GetHejjw:output_type -> shares.GetHejjwResp
	40, // 104: shares.shares.GetDailyCheck:output_type -> shares.GetDailyCheckResp
	0,  // 105: shares.shares.GetClmx:output_type -> shares.GetClmxResp
	72, // 106: shares.shares.GetMyYd:output_type -> shares.GetMyYdResp
	38, // 107: shares.shares.GetHyRm:output_type -> shares.GetHyRmResp
	36, // 108: shares.shares.GetMyTeam:output_type -> shares.GetMyTeamResp
	35, // 109: shares.shares.GetMyTeamDetail:output_type -> shares.GetMyTeamDetailResp
	33, // 110: shares.shares.GetHyMmadd:output_type -> shares.GetHyMmaddResp
	33, // 111: shares.shares.GetHyZyb:output_type -> shares.GetHyMmaddResp
	29, // 112: shares.shares.GetSharesKline:output_type -> shares.GetSharesKlineResp
	22, // 113: shares.shares.GetFundKline:output_type -> shares.GetFundKlineResp
	23, // 114: shares.shares.GetJgKline:output_type -> shares.GetJgKlineResp
	31, // 115: shares.shares.GetGzKline:output_type -> shares.GZPeResp
	26, // 116: shares.shares.GetHotHyName:output_type -> shares.GetHotHyNameResp
	21, // 117: shares.shares.GetYyq:output_type -> shares.GetYyqResp
	14, // 118: shares.shares.GetMrtList:output_type -> shares.GetMrtListResp
	12, // 119: shares.shares.GetMrtCode:output_type -> shares.GetMrtCodeResp
	78, // 120: shares.shares.UpsetMrtCode:output_type -> common.Empty
	7,  // 121: shares.shares.GetMrtDetail:output_type -> shares.GetMrtDetailResp
