...
var file_shares_shares_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x22, 0x63, 0x0a, 0x09, 0x4b, 0x6c, 0x69, 0x6e, 0x65, 0x49, 0x6e, 0x66,
	...
	0x52, 0x04, 0x63, 0x6f, 0x64, 0x65, 0x22, 0x7a, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x48, 0x79, 0x4d,
	0x6d, 0x61, 0x64, 0x64, 0x52, 0x65, 0x73, 0x70, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x69, 0x74, 0x6c,
	...
	0x79, 0x30, 0x12, 0x16, 0x0a, 0x06, 0x74, 0x68, 0x4c, 0x69, 0x73, 0x74, 0x18, 0x03, 0x20, 0x03,
	0x28, 0x09, 0x52, 0x06, 0x74, 0x68, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x26, 0x0a, 0x04, 0x6c, 0x69,
	0x73, 0x74, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x73, 0x68, 0x61, 0x72, 0x65,
	...
	0x63, 0x6b, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x22, 0x9a, 0x03, 0x0a,
	...
	0x28, 0x09, 0x52, 0x03, 0x69, 0x6d, 0x67, 0x12, 0x0e, 0x0a, 0x02, 0x68, 0x79, 0x18, 0x0b, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x02, 0x68, 0x79, 0x12, 0x16, 0x0a, 0x06, 0x6d, 0x61, 0x69, 0x6e, 0x48,
	...
	0x12, 0x12, 0x0a, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x04,
	0x6c, 0x69, 0x73, 0x74, 0x32, 0xd9, 0x0c, 0x0a, 0x06, 0x73, 0x68, 0x61, 0x72, 0x65, 0x73, 0x12,
	...
	0x6e, 0x65, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x12, 0x41, 0x0a, 0x0a, 0x47, 0x65, 0x74, 0x4a,
	0x67, 0x4b, 0x6c, 0x69, 0x6e, 0x65, 0x12, 0x19, 0x2e, 0x73, 0x68, 0x61, 0x72, 0x65, 0x73, 0x2e,
	0x47, 0x65, 0x74, 0x53, 0x68, 0x61, 0x72, 0x65, 0x73, 0x4b, 0x6c, 0x69, 0x6e, 0x65, 0x52, 0x65,
	0x71, 0x1a, 0x16, 0x2e, 0x73, 0x68, 0x61, 0x72, 0x65, 0x73, 0x2e, 0x47, 0x65, 0x74, 0x4a, 0x67,
	...
	0x42, 0x0c, 0x5a, 0x0a, 0x72, 0x70, 0x63, 0x2f, 0x73, 0x68, 0x61, 0x72, 0x65, 0x73, 0x62, 0x06,
...
var file_shares_shares_proto_msgTypes = make([]protoimpl.MessageInfo, 51)
var file_shares_shares_proto_goTypes = []interface{}{
	(*KlineInfo)(nil),           // 0: shares.KlineInfo
	(*GetYyqReq)(nil),           // 1: shares.GetYyqReq
	(*GetYyqResp)(nil),          // 2: shares.GetYyqResp
	(*GetFundKlineResp)(nil),    // 3: shares.GetFundKlineResp
	(*GetJgKlineResp)(nil),      // 4: shares.GetJgKlineResp
	(*EchartsKeyLineInfo)(nil),  // 5: shares.EchartsKeyLineInfo
	(*GetHotHyNameReq)(nil),     // 6: shares.GetHotHyNameReq
	(*GetHotHyNameResp)(nil),    // 7: shares.GetHotHyNameResp
	(*HyCodeInfo)(nil),          // 8: shares.HyCodeInfo
	(*GetSharesKlineReq)(nil),   // 9: shares.GetSharesKlineReq
	(*GetSharesKlineResp)(nil),  // 10: shares.GetSharesKlineResp
	(*GZPeResp)(nil),            // 11: shares.GZPeResp
	(*GetHyMmaddReq)(nil),       // 12: shares.GetHyMmaddReq
	(*GetHyMmaddResp)(nil),      // 13: shares.GetHyMmaddResp
	(*GetMyTeamDetailReq)(nil),  // 14: shares.GetMyTeamDetailReq
	(*GetMyTeamDetailResp)(nil), // 15: shares.GetMyTeamDetailResp
	(*GetMyTeamResp)(nil),       // 16: shares.GetMyTeamResp
	(*GetHyRmReq)(nil),          // 17: shares.GetHyRmReq
	(*GetHyRmResp)(nil),         // 18: shares.GetHyRmResp
	(*DailyCheckInfo)(nil),      // 19: shares.DailyCheckInfo
	(*GetDailyCheckResp)(nil),   // 20: shares.GetDailyCheckResp
	(*SharesInfo)(nil),          // 21: shares.SharesInfo
	(*SharesInfoDetails)(nil),   // 22: shares.SharesInfoDetails
	(*Group)(nil),               // 23: shares.Group
	(*GetGroupResp)(nil),        // 24: shares.GetGroupResp
	(*SearchReq)(nil),           // 25: shares.SearchReq
	(*SearchResp)(nil),          // 26: shares.SearchResp
	(*GetsReq)(nil),             // 27: shares.GetsReq
	(*SimpleSharesInfo)(nil),    // 28: shares.SimpleSharesInfo
	(*GetsResp)(nil),            // 29: shares.GetsResp
	(*CodeNameInfo)(nil),        // 30: shares.CodeNameInfo
	(*GetAllCodeNameResp)(nil),  // 31: shares.GetAllCodeNameResp
	(*AddMyCodeReq)(nil),        // 32: shares.AddMyCodeReq
	(*AddMyCodeResp)(nil),       // 33: shares.AddMyCodeResp
	(*GetMyCodeReq)(nil),        // 34: shares.GetMyCodeReq
	(*AddMyCodeInfo)(nil),       // 35: shares.AddMyCodeInfo
	(*GetMyCodeResp)(nil),       // 36: shares.GetMyCodeResp
	(*Msg)(nil),                 // 37: shares.Msg
	(*GetMsgResp)(nil),          // 38: shares.GetMsgResp
	(*HaveNewMsgResp)(nil),      // 39: shares.HaveNewMsgResp
	(*DeleteMyCodeReq)(nil),     // 40: shares.DeleteMyCodeReq
	(*AddGroupReq)(nil),         // 41: shares.AddGroupReq
	(*CodeReq)(nil),             // 42: shares.CodeReq
	(*GetMyGroupResp)(nil),      // 43: shares.GetMyGroupResp
	(*UpsetGroupCodeReq)(nil),   // 44: shares.UpsetGroupCodeReq
	(*GetDayResp)(nil),          // 45: shares.GetDayResp
	(*GetHyCodeResp)(nil),       // 46: shares.GetHyCodeResp
	(*HyTimeData)(nil),          // 47: shares.HyTimeData
	(*GetHyTimeReq)(nil),        // 48: shares.GetHyTimeReq
	(*GetHyTimeResp)(nil),       // 49: shares.GetHyTimeResp
	(*GetTouTiaoResp)(nil),      // 50: shares.GetTouTiaoResp
	(*common.SimpSharInfo)(nil), // 51: common.SimpSharInfo
	(*anypb.Any)(nil),           // 52: google.protobuf.Any
	(*common.Empty)(nil),        // 53: common.Empty
}
var file_shares_shares_proto_depIdxs = []int32{
	0,  // 0: shares.GetYyqResp.bx:type_name -> shares.KlineInfo
	0,  // 1: shares.GetYyqResp.rzrq:type_name -> shares.KlineInfo
	0,  // 2: shares.GetYyqResp.mlf:type_name -> shares.KlineInfo
	0,  // 3: shares.GetYyqResp.cpi:type_name -> shares.KlineInfo
	0,  // 4: shares.GetYyqResp.ppi:type_name -> shares.KlineInfo
	0,  // 5: shares.GetYyqResp.gdp:type_name -> shares.KlineInfo
	0,  // 6: shares.GetYyqResp.pmi:type_name -> shares.KlineInfo
	0,  // 7: shares.GetYyqResp.qyjqzs:type_name -> shares.KlineInfo
	0,  // 8: shares.GetYyqResp.gyzjz:type_name -> shares.KlineInfo
	0,  // 9: shares.GetYyqResp.xfzxx:type_name -> shares.KlineInfo
	0,  // 10: shares.GetYyqResp.m2:type_name -> shares.KlineInfo
	0,  // 11: shares.GetYyqResp.hgjck:type_name -> shares.KlineInfo
	0,  // 12: shares.GetYyqResp.fdi:type_name -> shares.KlineInfo
	0,  // 13: shares.GetYyqResp.xzxd:type_name -> shares.KlineInfo
	8,  // 14: shares.GetHotHyNameResp.list:type_name -> shares.HyCodeInfo
	21, // 15: shares.GetHyMmaddResp.list:type_name -> shares.SharesInfo
	21, // 16: shares.GetMyTeamDetailResp.list:type_name -> shares.SharesInfo
	51, // 17: shares.GetHyRmResp.list:type_name -> common.SimpSharInfo
	19, // 18: shares.GetDailyCheckResp.list:type_name -> shares.DailyCheckInfo
	21, // 19: shares.Group.list:type_name -> shares.SharesInfo
	23, // 20: shares.GetGroupResp.list:type_name -> shares.Group
	21, // 21: shares.SearchResp.info:type_name -> shares.SharesInfo
	28, // 22: shares.GetsResp.list:type_name -> shares.SimpleSharesInfo
	30, // 23: shares.GetAllCodeNameResp.list:type_name -> shares.CodeNameInfo
	32, // 24: shares.GetMyCodeResp.list:type_name -> shares.AddMyCodeReq
	37, // 25: shares.GetMsgResp.list:type_name -> shares.Msg
	23, // 26: shares.GetDayResp.list:type_name -> shares.Group
	23, // 27: shares.GetHyCodeResp.list:type_name -> shares.Group
	52, // 28: shares.HyTimeData.data:type_name -> google.protobuf.Any
	47, // 29: shares.GetHyTimeResp.data:type_name -> shares.HyTimeData
	53, // 30: shares.shares.GetGroup:input_type -> common.Empty
	42, // 31: shares.shares.GetMyGroup:input_type -> shares.CodeReq
	44, // 32: shares.shares.UpsetGroupCode:input_type -> shares.UpsetGroupCodeReq
	25, // 33: shares.shares.Search:input_type -> shares.SearchReq
	27, // 34: shares.shares.Gets:input_type -> shares.GetsReq
	53, // 35: shares.shares.GetAllCodeName:input_type -> common.Empty
	32, // 36: shares.shares.AddMyCode:input_type -> shares.AddMyCodeReq
	34, // 37: shares.shares.GetMyCode:input_type -> shares.GetMyCodeReq
	53, // 38: shares.shares.GetMsg:input_type -> common.Empty
	53, // 39: shares.shares.HaveNewMsg:input_type -> common.Empty
	40, // 40: shares.shares.DeleteMyCode:input_type -> shares.DeleteMyCodeReq
	41, // 41: shares.shares.AddGroup:input_type -> shares.AddGroupReq
	42, // 42: shares.shares.GetDay:input_type -> shares.CodeReq
	42, // 43: shares.shares.GetVip:input_type -> shares.CodeReq
	42, // 44: shares.shares.GetFl:input_type -> shares.CodeReq
	42, // 45: shares.shares.GetUp:input_type -> shares.CodeReq
	53, // 46: shares.shares.GetDailyCheck:input_type -> common.Empty
	17, // 47: shares.shares.GetHyRm:input_type -> shares.GetHyRmReq
	53, // 48: shares.shares.GetMyTeam:input_type -> common.Empty
	14, // 49: shares.shares.GetMyTeamDetail:input_type -> shares.GetMyTeamDetailReq
	12, // 50: shares.shares.GetHyMmadd:input_type -> shares.GetHyMmaddReq
	12, // 51: shares.shares.GetHyZyb:input_type -> shares.GetHyMmaddReq
	9,  // 52: shares.shares.GetSharesKline:input_type -> shares.GetSharesKlineReq
	9,  // 53: shares.shares.GetFundKline:input_type -> shares.GetSharesKlineReq
	9,  // 54: shares.shares.GetJgKline:input_type -> shares.GetSharesKlineReq
	9,  // 55: shares.shares.GetGzKline:input_type -> shares.GetSharesKlineReq
	6,  // 56: shares.shares.GetHotHyName:input_type -> shares.GetHotHyNameReq
	1,  // 57: shares.shares.GetYyq:input_type -> shares.GetYyqReq
	24, // 58: shares.shares.GetGroup:output_type -> shares.GetGroupResp
	43, // 59: shares.shares.GetMyGroup:output_type -> shares.GetMyGroupResp
	53, // 60: shares.shares.UpsetGroupCode:output_type -> common.Empty
	26, // 61: shares.shares.Search:output_type -> shares.SearchResp
	29, // 62: shares.shares.Gets:output_type -> shares.GetsResp
	31, // 63: shares.shares.GetAllCodeName:output_type -> shares.GetAllCodeNameResp
	33, // 64: shares.shares.AddMyCode:output_type -> shares.AddMyCodeResp
	36, // 65: shares.shares.GetMyCode:output_type -> shares.GetMyCodeResp
	38, // 66: shares.shares.GetMsg:output_type -> shares.GetMsgResp
	39, // 67: shares.shares.HaveNewMsg:output_type -> shares.HaveNewMsgResp
	53, // 68: shares.shares.DeleteMyCode:output_type -> common.Empty
	53, // 69: shares.shares.AddGroup:output_type -> common.Empty
	45, // 70: shares.shares.GetDay:output_type -> shares.GetDayResp
	45, // 71: shares.shares.GetVip:output_type -> shares.GetDayResp
	45, // 72: shares.shares.GetFl:output_type -> shares.GetDayResp
	45, // 73: shares.shares.GetUp:output_type -> shares.GetDayResp
	20, // 74: shares.shares.GetDailyCheck:output_type -> shares.GetDailyCheckResp
	18, // 75: shares.shares.GetHyRm:output_type -> shares.GetHyRmResp
	16, // 76: shares.shares.GetMyTeam:output_type -> shares.GetMyTeamResp
	15, // 77: shares.shares.GetMyTeamDetail:output_type -> shares.GetMyTeamDetailResp
	13, // 78: shares.shares.GetHyMmadd:output_type -> shares.GetHyMmaddResp
	13, // 79: shares.shares.GetHyZyb:output_type -> shares.GetHyMmaddResp
	10, // 80: shares.shares.GetSharesKline:output_type -> shares.GetSharesKlineResp
	3,  // 81: shares.shares.GetFundKline:output_type -> shares.GetFundKlineResp
	4,  // 82: shares.shares.GetJgKline:output_type -> shares.GetJgKlineResp
	11, // 83: shares.shares.GetGzKline:output_type -> shares.GZPeResp
	7,  // 84: shares.shares.GetHotHyName:output_type -> shares.GetHotHyNameResp
	2,  // 85: shares.shares.GetYyq:output_type -> shares.GetYyqResp
