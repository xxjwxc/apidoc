...
var file_shares_shares_proto_rawDesc = []byte{
	...
	0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x22, 0x98, 0x02, 0x0a, 0x0c, 0x41,
	...
	0x14, 0x0a, 0x05, 0x76, 0x61, 0x69, 0x6c, 0x64, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x08, 0x52, 0x05,
	0x76, 0x61, 0x69, 0x6c, 0x64, 0x22, 0x39, 0x0a, 0x0d, 0x41, 0x64, 0x64, 0x4d, 0x79, 0x43, 0x6f,
	...
	0x04, 0x6c, 0x69, 0x73, 0x74, 0x32, 0xd2, 0x02, 0x0a, 0x06, 0x73, 0x68, 0x61, 0x72, 0x65, 0x73,
...
var file_shares_shares_proto_msgTypes = make([]protoimpl.MessageInfo, 15)
var file_shares_shares_proto_goTypes = []interface{}{
	...
	(*GetMyCodeReq)(nil),       // 12: shares.GetMyCodeReq
	(*AddMyCodeInfo)(nil),      // 13: shares.AddMyCodeInfo
	(*GetMyCodeResp)(nil),      // 14: shares.GetMyCodeResp
...
var file_shares_shares_proto_depIdxs = []int32{
	...
	10, // 5: shares.GetMyCodeResp.list:type_name -> shares.AddMyCodeReq
	15, // 6: shares.shares.GetGroup:input_type -> common.Empty
	3,  // 7: shares.shares.Search:input_type -> shares.SearchReq
	5,  // 8: shares.shares.Gets:input_type -> shares.GetsReq
	15, // 9: shares.shares.GetAllCodeName:input_type -> common.Empty
	10, // 10: shares.shares.AddMyCode:input_type -> shares.AddMyCodeReq
	12, // 11: shares.shares.GetMyCode:input_type -> shares.GetMyCodeReq
	2,  // 12: shares.shares.GetGroup:output_type -> shares.GetGroupResp
	4,  // 13: shares.shares.Search:output_type -> shares.SearchResp
	7,  // 14: shares.shares.Gets:output_type -> shares.GetsResp
	9,  // 15: shares.shares.GetAllCodeName:output_type -> shares.GetAllCodeNameResp
	11, // 16: shares.shares.AddMyCode:output_type -> shares.AddMyCodeResp
	14, // 17: shares.shares.GetMyCode:output_type -> shares.GetMyCodeResp
