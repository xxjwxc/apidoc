...
type FlowInfo struct {
	...
	FlowId        string                 `protobuf:"bytes,1,opt,name=flowId,proto3" json:"flowId" jsonschema_description:"为空创建"`       // 为空创建
	Title         string                 `protobuf:"bytes,2,opt,name=title,proto3" json:"title" jsonschema_description:"标题（不为空的时候修改）"` // 标题（不为空的时候修改）
	BgColor       string                 `protobuf:"bytes,3,opt,name=bgColor,proto3" json:"bgColor" jsonschema_description:"背景色"`      // 背景色
	Doc           string                 `protobuf:"bytes,4,opt,name=doc,proto3" json:"doc" jsonschema_description:"描述（不为空的时候修改）"`     // 描述（不为空的时候修改）
	Logo          string                 `protobuf:"bytes,5,opt,name=logo,proto3" json:"logo" jsonschema_description:"图标（不为空的时候修改）"`   // 图标（不为空的时候修改）
	Data          string                 `protobuf:"bytes,6,opt,name=data,proto3" json:"data" jsonschema_description:"数据 （不为空的时候修改）"`  // 数据 （不为空的时候修改）
...
type UpdateFlowReq struct {
	...
	FlowId        string                 `protobuf:"bytes,1,opt,name=flowId,proto3" json:"flowId" jsonschema_description:"为空创建"`       // 为空创建
	Title         string                 `protobuf:"bytes,2,opt,name=title,proto3" json:"title" jsonschema_description:"标题（不为空的时候修改）"` // 标题（不为空的时候修改）
	Doc           string                 `protobuf:"bytes,3,opt,name=doc,proto3" json:"doc" jsonschema_description:"描述（不为空的时候修改）"`     // 描述（不为空的时候修改）
	Logo          string                 `protobuf:"bytes,4,opt,name=logo,proto3" json:"logo" jsonschema_description:"图标（不为空的时候修改）"`   // 图标（不为空的时候修改）
	BgColor       string                 `protobuf:"bytes,5,opt,name=bgColor,proto3" json:"bgColor" jsonschema_description:"背景色"`      // 背景色
	Data          string                 `protobuf:"bytes,6,opt,name=data,proto3" json:"data" jsonschema_description:"数据 （不为空的时候修改）"`  // 数据 （不为空的时候修改）
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetFlowReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	FlowId        string                 `protobuf:"bytes,1,opt,name=flowId,proto3" json:"flowId" jsonschema_description:"为空获取所有"` // 为空获取所有
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ChatFlowReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	FlowId        string                 `protobuf:"bytes,1,opt,name=flowId,proto3" json:"flowId" jsonschema_description:"工作流id"`             // 工作流id
	NodeId        string                 `protobuf:"bytes,2,opt,name=nodeId,proto3" json:"nodeId" jsonschema_description:"节点id(不为空视为测试目标节点)"` // 节点id(不为空视为测试目标节点)
	IsChange      string                 `protobuf:"bytes,3,opt,name=isChange,proto3" json:"isChange" jsonschema_description:"是否变更节点"`        // 是否变更节点
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetPromptReq struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Tag           string                 `protobuf:"bytes,1,opt,name=tag,proto3" json:"tag" jsonschema_description:"标签(技能：skill，提示：tip)"` // 标签(技能：skill，提示：tip)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type GetPromptResp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	List          []*PromptInfo          `protobuf:"bytes,1,rep,name=list,proto3" json:"list" jsonschema_description:"提示列表"` // 提示列表
	Tips          []string               `protobuf:"bytes,2,rep,name=tips,proto3" json:"tips" jsonschema_description:"提示列表"` // 提示列表
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
