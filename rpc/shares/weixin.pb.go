...
var file_shares_weixin_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x03, 0x75, 0x72, 0x6c, 0x32, 0xab, 0x01, 0x0a, 0x06, 0x57, 0x65, 0x69,
...
var file_shares_weixin_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
...
var file_shares_weixin_proto_depIdxs = []int32{
	...
	6, // 4: shares.Weixin.UpdateUserInfo:output_type -> common.Empty
	5, // 5: shares.Weixin.GetQrcode:output_type -> shares.GetQrcodeResp
