...
var file_shares_weixin_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x75, 0x65, 0x32, 0xa0, 0x02, 0x0a, 0x06, 0x57, 0x65, 0x69, 0x78, 0x69, 0x6e, 0x12,
	...
	0x22, 0x00, 0x12, 0x37, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66,
...
var file_shares_weixin_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
...
var file_shares_weixin_proto_depIdxs = []int32{
	...
	8, // 3: shares.Weixin.GetUserInfo:input_type -> common.Empty
	7, // 4: shares.Weixin.UpsetUserInfo:input_type -> shares.UpsetUserInfoReq
	1, // 5: shares.Weixin.Oauth:output_type -> shares.OauthResp
	8, // 6: shares.Weixin.UpdateUserInfo:output_type -> common.Empty
	5, // 7: shares.Weixin.GetQrcode:output_type -> shares.GetQrcodeResp
	6, // 8: shares.Weixin.GetUserInfo:output_type -> shares.GetUserInfoResp
	8, // 9: shares.Weixin.UpsetUserInfo:output_type -> common.Empty
