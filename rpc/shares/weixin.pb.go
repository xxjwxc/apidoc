...
var file_shares_weixin_proto_rawDesc = []byte{
	...
	0x05, 0x50, 0x68, 0x6f, 0x6e, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x18,
	...
	0x43, 0x61, 0x70, 0x61, 0x63, 0x69, 0x74, 0x79, 0x32, 0xe4, 0x01, 0x0a, 0x06, 0x57, 0x65, 0x69,
	...
	0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x12, 0x37, 0x0a, 0x0b, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65,
	0x72, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x0d, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x45,
	0x6d, 0x70, 0x74, 0x79, 0x1a, 0x17, 0x2e, 0x73, 0x68, 0x61, 0x72, 0x65, 0x73, 0x2e, 0x47, 0x65,
	0x74, 0x55, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x42,
...
var file_shares_weixin_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
...
var file_shares_weixin_proto_depIdxs = []int32{
	...
	7, // 3: shares.Weixin.GetUserInfo:input_type -> common.Empty
	1, // 4: shares.Weixin.Oauth:output_type -> shares.OauthResp
	7, // 5: shares.Weixin.UpdateUserInfo:output_type -> common.Empty
	5, // 6: shares.Weixin.GetQrcode:output_type -> shares.GetQrcodeResp
	6, // 7: shares.Weixin.GetUserInfo:output_type -> shares.GetUserInfoResp
