...
var file_shares_shares_proto_rawDesc = []byte{
	...
	0x03, 0x70, 0x65, 0x67, 0x22, 0xa9, 0x04, 0x0a, 0x11, 0x53, 0x68, 0x61, 0x72, 0x65, 0x73, 0x49,
	...
	0x66, 0x6f, 0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x22, 0xa4, 0x03, 0x0a, 0x0c, 0x41, 0x64, 0x64,
	...
	,
	...
	0x70, 0x12, 0x10, 0x0a, 0x03, 0x64, 0x6f, 0x63, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03,
	...
	0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x32, 0xd5, 0x06, 0x0a, 0x06, 0x73, 0x68, 0x61, 0x72, 0x65,
...
var file_shares_shares_proto_msgTypes = make([]protoimpl.MessageInfo, 26)
...
var file_shares_shares_proto_depIdxs = []int32{
	...
	26, // 9: shares.shares.GetGroup:input_type -> common.Empty
	21, // 10: shares.shares.GetMyGroup:input_type -> shares.CodeReq
	23, // 11: shares.shares.UpsetGroupCode:input_type -> shares.UpsetGroupCodeReq
	4,  // 12: shares.shares.Search:input_type -> shares.SearchReq
	6,  // 13: shares.shares.Gets:input_type -> shares.GetsReq
	26, // 14: shares.shares.GetAllCodeName:input_type -> common.Empty
	11, // 15: shares.shares.AddMyCode:input_type -> shares.AddMyCodeReq
	13, // 16: shares.shares.GetMyCode:input_type -> shares.GetMyCodeReq
	26, // 17: shares.shares.GetMsg:input_type -> common.Empty
	26, // 18: shares.shares.HaveNewMsg:input_type -> common.Empty
	19, // 19: shares.shares.DeleteMyCode:input_type -> shares.DeleteMyCodeReq
	20, // 20: shares.shares.AddGroup:input_type -> shares.AddGroupReq
	26, // 21: shares.shares.GetDay:input_type -> common.Empty
	26, // 22: shares.shares.GetVip:input_type -> common.Empty
	26, // 23: shares.shares.GetFl:input_type -> common.Empty
	26, // 24: shares.shares.GetUp:input_type -> common.Empty
	3,  // 25: shares.shares.GetGroup:output_type -> shares.GetGroupResp
	22, // 26: shares.shares.GetMyGroup:output_type -> shares.GetMyGroupResp
	26, // 27: shares.shares.UpsetGroupCode:output_type -> common.Empty
	5,  // 28: shares.shares.Search:output_type -> shares.SearchResp
	8,  // 29: shares.shares.Gets:output_type -> shares.GetsResp
	10, // 30: shares.shares.GetAllCodeName:output_type -> shares.GetAllCodeNameResp
	12, // 31: shares.shares.AddMyCode:output_type -> shares.AddMyCodeResp
	15, // 32: shares.shares.GetMyCode:output_type -> shares.GetMyCodeResp
	17, // 33: shares.shares.GetMsg:output_type -> shares.GetMsgResp
	18, // 34: shares.shares.HaveNewMsg:output_type -> shares.HaveNewMsgResp
	26, // 35: shares.shares.DeleteMyCode:output_type -> common.Empty
	26, // 36: shares.shares.AddGroup:output_type -> common.Empty
	24, // 37: shares.shares.GetDay:output_type -> shares.GetDayResp
	24, // 38: shares.shares.GetVip:output_type -> shares.GetDayResp
	24, // 39: shares.shares.GetFl:output_type -> shares.GetDayResp
	24, // 40: shares.shares.GetUp:output_type -> shares.GetDayResp
