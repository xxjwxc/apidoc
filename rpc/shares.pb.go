...
var file_shares_shares_proto_rawDesc = []byte{
	...
	0x2e, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x52, 0x04, 0x6c, 0x69, 0x73, 0x74, 0x32, 0xa7, 0x06, 0x0a,
...
var file_shares_shares_proto_depIdxs = []int32{
	...
	25, // 21: shares.shares.GetVip:input_type -> common.Empty
	25, // 22: shares.shares.GetFl:input_type -> common.Empty
	3,  // 23: shares.shares.GetGroup:output_type -> shares.GetGroupResp
	22, // 24: shares.shares.GetMyGroup:output_type -> shares.GetMyGroupResp
	25, // 25: shares.shares.UpsetGroupCode:output_type -> common.Empty
	5,  // 26: shares.shares.Search:output_type -> shares.SearchResp
	8,  // 27: shares.shares.Gets:output_type -> shares.GetsResp
	10, // 28: shares.shares.GetAllCodeName:output_type -> shares.GetAllCodeNameResp
	12, // 29: shares.shares.AddMyCode:output_type -> shares.AddMyCodeResp
	15, // 30: shares.shares.GetMyCode:output_type -> shares.GetMyCodeResp
	17, // 31: shares.shares.GetMsg:output_type -> shares.GetMsgResp
	18, // 32: shares.shares.HaveNewMsg:output_type -> shares.HaveNewMsgResp
	25, // 33: shares.shares.DeleteMyCode:output_type -> common.Empty
	25, // 34: shares.shares.AddGroup:output_type -> common.Empty
	24, // 35: shares.shares.GetDay:output_type -> shares.GetDayResp
	24, // 36: shares.shares.GetVip:output_type -> shares.GetDayResp
	24, // 37: shares.shares.GetFl:output_type -> shares.GetDayResp
